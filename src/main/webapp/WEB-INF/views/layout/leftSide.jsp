...
<!-- 										<img src="/resources//resources/images/pic10.jpg" alt="" /> -->
<!-- 									</span> -->
<!-- 								</section> -->
				...
				<!-- Sidebar -->
					<div id="sidebar">
						<div class="inner">
							...
							<!-- Footer -->
								<footer id="footer">
									<p class="copyright">&copy; Untitled. All rights reserved. Demo /resources/images: <a href="https://unsplash.com">Unsplash</a>. Design: <a href="https://html5up.net">HTML5 UP</a>.</p>
								</footer>
